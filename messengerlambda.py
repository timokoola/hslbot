"""Lambda handle function for messenger bot"""
...
from keys import hsl_username, hsl_passcode, facebook_bot_key
from pymessenger.bot import Bot
import json


def lambda_handler(event, context):
    """Lambda handle function for messenger bot, calls are
    ...
    try:
        ...
        bot = Bot(facebook_bot_key)
        recipient_id = event["body-json"]["entry"][0]["messaging"][0]["sender"]["id"]
        bot.send_text_message(recipient_id, send_help_text(None))
